...
class DocscanPipelineParityTest {
    ...
    void loadsAndRunsAGraphShapedPipelineEndToEnd() throws Exception {
        ...
        List<Map<String, Object>> saved = ((io.provisionlabs.agentsgraph.engine.InMemoryOutputSink) engine.getOutputSink())
    ...
    public static class TestDocscanOcrProcessor implements io.provisionlabs.agentsgraph.engine.Processor {
        @Override
    ...
    public static class TestLlmPostProcessor implements io.provisionlabs.agentsgraph.engine.Processor {
        @Override
        public Map<String, Object> execute(ExecutionContext context, StepDefinition step) {
